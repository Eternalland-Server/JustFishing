package net.sakuragame.eternal.fishing.core.task;
...
public class ManualFishing extends BukkitRunnable {
    ...
    public ManualFishing(Player player, int goal, double time) {
        this.player = player;
        this.goal = goal;
